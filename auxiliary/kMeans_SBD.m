function [member_id, centers, clusters] = kMeans_SBD(A, K)
% distance: SBD
...
for iter = 1:100
    ...
    for k = 1:K
        centers(k,:) = kMeans_SBD_centroid(member_id, A, k, centers(k,:));     
    end
...
function centroid = kMeans_SBD_centroid(member_id, A, k)
%Computes centroid
a = [];
